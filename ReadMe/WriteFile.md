...
#### Concepts
These concepts are focus on the **Java I/O API**, and how to use it to write into a file.
...
#### Problem
Write into an existing file using `FileOutputStream` class.
...
6. In the main method call the `writeFile(filePath, content)` method, and pass the file path and the content to be written into the file.
